...
published <- spread(attrs[attrs$key == "yearpublished",], key, value)
rated2 <- left_join(rated.games, published)
ggplot(rated2, aes(x=yearpublished, y=rating)) +
  geom_point(alpha=0.5, color="#c46c5b")
ggplot(rated2, aes(x=yearpublished, y=rating)) +
